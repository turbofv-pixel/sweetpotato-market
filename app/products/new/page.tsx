...
export default function NewProductPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* 헤더 */}
      <div className="mb-6">
        <a href="/" className="inline-flex items-center gap-1 text-sm text-[#2E7D32] font-bold mb-4 hover:underline">
          ← 목록으로 돌아가기
        </a>
        <div className="flex items-center gap-3">
          <div className="h-8 w-2 bg-[#2E7D32] rounded-full" />
          <h1 className="text-2xl font-bold text-[#1B5E20]">상품 등록</h1>
        </div>
        <p className="text-sm text-gray-500 mt-1 ml-5">판매할 상품 정보를 입력해주세요 🌾</p>
      </div>
      ...
      >
        ...
        <div className="px-6 pb-6 flex gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex-2 w-full py-3 bg-[#2E7D32] text-white font-bold rounded-sm
