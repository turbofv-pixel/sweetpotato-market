...
export default function LoginPage() {
  ...
  async function handleEmailAuth(e: React.FormEvent) {
    e.preventDefault()
    if (!email || !password) {
      showMsg('이메일과 비밀번호를 입력해주세요.', true)
      return
    }
    setLoading(true)
    setMessage('')
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-5">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 py-3 border-2 border-gray-200
                  rounded-sm font-bold text-sm text-gray-700 hover:bg-gray-50
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3
                  bg-[#FEE500] border-2 border-[#FEE500] rounded-sm font-bold text-sm text-[#3C1E1E]
            ...
            <form onSubmit={handleEmailAuth} className="space-y-3">
              ...
              {message && (
                <div className={`text-sm px-3 py-2 rounded-sm border ${
                  isError
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-[#2E7D32] text-white font-bold rounded-sm
